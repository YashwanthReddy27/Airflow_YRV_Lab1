...
with DAG(
    ...
    trigger_bash_dag = TriggerDagRunOperator(
        task_id="trigger_bash_dag",
        trigger_dag_id="bash_operator_dag",  # Ensure this matches the actual DAG ID
    )

    # Set task dependencies
    load_data_task >> data_preprocessing_task >> build_save_model_task >> load_model_task >> trigger_bash_dag
